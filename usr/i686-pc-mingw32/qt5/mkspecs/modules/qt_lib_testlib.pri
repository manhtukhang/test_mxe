QT.testlib.VERSION = 5.1.0
QT.testlib.MAJOR_VERSION = 5
QT.testlib.MINOR_VERSION = 1
QT.testlib.PATCH_VERSION = 0
QT.testlib.name = QtTest
QT.testlib.libs = $$QT_MODULE_LIB_BASE
QT.testlib.private_includes = $$QT_MODULE_INCLUDE_BASE/QtTest/5.1.0 $$QT_MODULE_INCLUDE_BASE/QtTest/5.1.0/QtTest
...
QT.testlib.module_config = staticlib
