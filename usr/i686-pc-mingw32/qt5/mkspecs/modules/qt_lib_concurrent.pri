QT.concurrent.VERSION = 5.1.0
QT.concurrent.MAJOR_VERSION = 5
QT.concurrent.MINOR_VERSION = 1
QT.concurrent.PATCH_VERSION = 0
QT.concurrent.name = QtConcurrent
QT.concurrent.libs = $$QT_MODULE_LIB_BASE
QT.concurrent.private_includes = $$QT_MODULE_INCLUDE_BASE/QtConcurrent/5.1.0 $$QT_MODULE_INCLUDE_BASE/QtConcurrent/5.1.0/QtConcurrent
...
QT.concurrent.module_config = staticlib
