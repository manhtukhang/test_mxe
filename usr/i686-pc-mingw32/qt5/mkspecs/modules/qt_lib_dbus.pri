QT.dbus.VERSION = 5.1.0
QT.dbus.MAJOR_VERSION = 5
QT.dbus.MINOR_VERSION = 1
QT.dbus.PATCH_VERSION = 0
QT.dbus.name = QtDBus
QT.dbus.libs = $$QT_MODULE_LIB_BASE
QT.dbus.private_includes = $$QT_MODULE_INCLUDE_BASE/QtDBus/5.1.0 $$QT_MODULE_INCLUDE_BASE/QtDBus/5.1.0/QtDBus
...
QT.dbus.module_config = staticlib
