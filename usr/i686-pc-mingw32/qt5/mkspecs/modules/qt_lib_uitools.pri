QT.uitools.VERSION = 5.1.0
QT.uitools.MAJOR_VERSION = 5
QT.uitools.MINOR_VERSION = 1
QT.uitools.PATCH_VERSION = 0
QT.uitools.name = QtUiTools
QT.uitools.libs = $$QT_MODULE_LIB_BASE
QT.uitools.private_includes = $$QT_MODULE_INCLUDE_BASE/QtUiTools/5.1.0 $$QT_MODULE_INCLUDE_BASE/QtUiTools/5.1.0/QtUiTools
