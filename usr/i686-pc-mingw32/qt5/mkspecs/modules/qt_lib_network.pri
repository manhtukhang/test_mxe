QT.network.VERSION = 5.1.0
QT.network.MAJOR_VERSION = 5
QT.network.MINOR_VERSION = 1
QT.network.PATCH_VERSION = 0
QT.network.name = QtNetwork
QT.network.libs = $$QT_MODULE_LIB_BASE
QT.network.private_includes = $$QT_MODULE_INCLUDE_BASE/QtNetwork/5.1.0 $$QT_MODULE_INCLUDE_BASE/QtNetwork/5.1.0/QtNetwork
...
QT.network.module_config = staticlib
