QT.multimedia.VERSION = 5.1.0
QT.multimedia.MAJOR_VERSION = 5
QT.multimedia.MINOR_VERSION = 1
QT.multimedia.PATCH_VERSION = 0
QT.multimedia.name = QtMultimedia
QT.multimedia.libs = $$QT_MODULE_LIB_BASE
QT.multimedia.private_includes = $$QT_MODULE_INCLUDE_BASE/QtMultimedia/5.1.0 $$QT_MODULE_INCLUDE_BASE/QtMultimedia/5.1.0/QtMultimedia
...
QT.multimedia.module_config = staticlib
