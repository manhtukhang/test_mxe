...
set(Qt5SerialPort_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::SerialPort)
    ...
    set(Qt5SerialPort_PRIVATE_INCLUDE_DIRS
        "${_qt5SerialPort_install_prefix}/include/QtSerialPort/${Qt5SerialPort_VERSION_STRING}"
        "${_qt5SerialPort_install_prefix}/include/QtSerialPort/${Qt5SerialPort_VERSION_STRING}/QtSerialPort"
    )

    foreach(_dir ${_Qt5SerialPort_OWN_INCLUDE_DIRS}
                 ${Qt5SerialPort_PRIVATE_INCLUDE_DIRS}
                 )
    ...
    foreach(_module_dep ${_Qt5SerialPort_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5SerialPort_VERSION_STRING} ${_Qt5SerialPort_FIND_VERSION_EXACT}
    ...
    if (Qt5SerialPort_EXECUTABLE_COMPILE_FLAGS)
    ...
    _populate_SerialPort_target_properties(RELEASE "libQt5SerialPort.a" "" )

    if (EXISTS "${_qt5SerialPort_install_prefix}/lib/libQt5SerialPortd.a" )
        _populate_SerialPort_target_properties(DEBUG "libQt5SerialPortd.a" "" )
    endif()
