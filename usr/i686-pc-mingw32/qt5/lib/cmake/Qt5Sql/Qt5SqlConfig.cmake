...
set(Qt5Sql_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::Sql)
    ...
    foreach(_module_dep ${_Qt5Sql_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5Sql_VERSION_STRING} ${_Qt5Sql_FIND_VERSION_EXACT}
    ...
    _populate_Sql_target_properties(RELEASE "libQt5Sql.a" "" )

    if (EXISTS "${_qt5Sql_install_prefix}/lib/libQt5Sqld.a" )
        _populate_Sql_target_properties(DEBUG "libQt5Sqld.a" "" )
    endif()
