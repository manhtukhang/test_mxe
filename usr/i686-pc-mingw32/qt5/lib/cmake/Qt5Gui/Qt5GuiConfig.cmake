...
set(Qt5Gui_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::Gui)
    ...
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/include/QtGui/${Qt5Gui_VERSION_STRING}"
        "${_qt5Gui_install_prefix}/include/QtGui/${Qt5Gui_VERSION_STRING}/QtGui"
    )
    ...
    foreach(_module_dep ${_Qt5Gui_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5Gui_VERSION_STRING} ${_Qt5Gui_FIND_VERSION_EXACT}
    ...
    if (Qt5Gui_EXECUTABLE_COMPILE_FLAGS)
    ...
    if (EXISTS "${_qt5Gui_install_prefix}/lib/libQt5Guid.a" )
        _populate_Gui_target_properties(DEBUG "libQt5Guid.a" "" )
    endif()
