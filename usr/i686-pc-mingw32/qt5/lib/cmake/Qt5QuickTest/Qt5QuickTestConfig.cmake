...
set(Qt5QuickTest_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::QuickTest)
    ...
    set(Qt5QuickTest_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTest_install_prefix}/include/QtQuickTest/${Qt5QuickTest_VERSION_STRING}"
        "${_qt5QuickTest_install_prefix}/include/QtQuickTest/${Qt5QuickTest_VERSION_STRING}/QtQuickTest"
    )
    ...
    foreach(_module_dep ${_Qt5QuickTest_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5QuickTest_VERSION_STRING} ${_Qt5QuickTest_FIND_VERSION_EXACT}
    ...
    if (Qt5QuickTest_EXECUTABLE_COMPILE_FLAGS)
    ...
    _populate_QuickTest_target_properties(RELEASE "libQt5QuickTest.a" "" )

    if (EXISTS "${_qt5QuickTest_install_prefix}/lib/libQt5QuickTestd.a" )
        _populate_QuickTest_target_properties(DEBUG "libQt5QuickTestd.a" "" )
    endif()
