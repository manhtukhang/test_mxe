...
set(Qt5Help_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::Help)
    ...
    foreach(_module_dep ${_Qt5Help_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5Help_VERSION_STRING} ${_Qt5Help_FIND_VERSION_EXACT}
    ...
    add_library(Qt5::Help STATIC IMPORTED)
    set_property(TARGET Qt5::Help PROPERTY IMPORTED_LINK_INTERFACE_LANGUAGES CXX)
    ...
    _populate_Help_target_properties(RELEASE "libQt5Help.a" "" )

    if (EXISTS "${_qt5Help_install_prefix}/lib/libQt5Helpd.a" )
        _populate_Help_target_properties(DEBUG "libQt5Helpd.a" "" )
    endif()
