...
set(Qt5Widgets_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::Widgets)
    ...
    foreach(_module_dep ${_Qt5Widgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5Widgets_VERSION_STRING} ${_Qt5Widgets_FIND_VERSION_EXACT}
    ...
    _populate_Widgets_target_properties(RELEASE "libQt5Widgets.a" "" )

    if (EXISTS "${_qt5Widgets_install_prefix}/lib/libQt5Widgetsd.a" )
        _populate_Widgets_target_properties(DEBUG "libQt5Widgetsd.a" "" )
    endif()
