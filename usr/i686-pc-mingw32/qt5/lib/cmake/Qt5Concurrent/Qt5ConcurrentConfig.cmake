...
set(Qt5Concurrent_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::Concurrent)
    ...
    foreach(_dir ${_Qt5Concurrent_OWN_INCLUDE_DIRS}
                 ${Qt5Concurrent_PRIVATE_INCLUDE_DIRS}
                 )
    ...
    foreach(_module_dep ${_Qt5Concurrent_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5Concurrent_VERSION_STRING} ${_Qt5Concurrent_FIND_VERSION_EXACT}
    ...
    if (Qt5Concurrent_EXECUTABLE_COMPILE_FLAGS)
    ...
    _populate_Concurrent_target_properties(RELEASE "libQt5Concurrent.a" "" )

    if (EXISTS "${_qt5Concurrent_install_prefix}/lib/libQt5Concurrentd.a" )
        _populate_Concurrent_target_properties(DEBUG "libQt5Concurrentd.a" "" )
    endif()
