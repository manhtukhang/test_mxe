...
set(Qt5ScriptTools_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::ScriptTools)
    ...
    foreach(_dir ${_Qt5ScriptTools_OWN_INCLUDE_DIRS}
                 ${Qt5ScriptTools_PRIVATE_INCLUDE_DIRS}
                 )
    ...
    foreach(_module_dep ${_Qt5ScriptTools_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5ScriptTools_VERSION_STRING} ${_Qt5ScriptTools_FIND_VERSION_EXACT}
    ...
    add_library(Qt5::ScriptTools STATIC IMPORTED)
    set_property(TARGET Qt5::ScriptTools PROPERTY IMPORTED_LINK_INTERFACE_LANGUAGES CXX)
    ...
    _populate_ScriptTools_target_properties(RELEASE "libQt5ScriptTools.a" "" )

    if (EXISTS "${_qt5ScriptTools_install_prefix}/lib/libQt5ScriptToolsd.a" )
        _populate_ScriptTools_target_properties(DEBUG "libQt5ScriptToolsd.a" "" )
    endif()
