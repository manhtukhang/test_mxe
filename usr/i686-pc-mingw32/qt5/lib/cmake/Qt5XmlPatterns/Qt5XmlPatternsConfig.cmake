...
set(Qt5XmlPatterns_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::XmlPatterns)
    ...
    foreach(_dir ${_Qt5XmlPatterns_OWN_INCLUDE_DIRS}
                 ${Qt5XmlPatterns_PRIVATE_INCLUDE_DIRS}
                 )
    ...
    foreach(_module_dep ${_Qt5XmlPatterns_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5XmlPatterns_VERSION_STRING} ${_Qt5XmlPatterns_FIND_VERSION_EXACT}
    ...
    _populate_XmlPatterns_target_properties(RELEASE "libQt5XmlPatterns.a" "" )

    if (EXISTS "${_qt5XmlPatterns_install_prefix}/lib/libQt5XmlPatternsd.a" )
        _populate_XmlPatterns_target_properties(DEBUG "libQt5XmlPatternsd.a" "" )
    endif()
