...
set(Qt5OpenGLExtensions_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::OpenGLExtensions)
    ...
    foreach(_dir ${_Qt5OpenGLExtensions_OWN_INCLUDE_DIRS}
                 ${Qt5OpenGLExtensions_PRIVATE_INCLUDE_DIRS}
                 )
    ...
    foreach(_module_dep ${_Qt5OpenGLExtensions_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5OpenGLExtensions_VERSION_STRING} ${_Qt5OpenGLExtensions_FIND_VERSION_EXACT}
    ...
    if (Qt5OpenGLExtensions_EXECUTABLE_COMPILE_FLAGS)
    ...
    if (EXISTS "${_qt5OpenGLExtensions_install_prefix}/lib/libQt5OpenGLExtensionsd.a" )
