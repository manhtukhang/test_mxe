...
set(Qt5AxServer_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::AxServer)
    ...
    foreach(_dir ${_Qt5AxServer_OWN_INCLUDE_DIRS}
                 ${Qt5AxServer_PRIVATE_INCLUDE_DIRS}
                 )
    ...
    foreach(_module_dep ${_Qt5AxServer_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5AxServer_VERSION_STRING} ${_Qt5AxServer_FIND_VERSION_EXACT}
    ...
    if (Qt5AxServer_EXECUTABLE_COMPILE_FLAGS)
    ...
    if (EXISTS "${_qt5AxServer_install_prefix}/lib/libQt5AxServerd.a" )
