...
set(Qt5DBus_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::DBus)
    ...
    foreach(_module_dep ${_Qt5DBus_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5DBus_VERSION_STRING} ${_Qt5DBus_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::DBus PROPERTY IMPORTED_LINK_INTERFACE_LANGUAGES CXX)
    ...
    _populate_DBus_target_properties(RELEASE "libQt5DBus.a" "" )

    if (EXISTS "${_qt5DBus_install_prefix}/lib/libQt5DBusd.a" )
        _populate_DBus_target_properties(DEBUG "libQt5DBusd.a" "" )
    endif()
