...
set(Qt5OpenGL_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::OpenGL)
    ...
    foreach(_module_dep ${_Qt5OpenGL_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5OpenGL_VERSION_STRING} ${_Qt5OpenGL_FIND_VERSION_EXACT}
    ...
    _populate_OpenGL_target_properties(RELEASE "libQt5OpenGL.a" "" )

    if (EXISTS "${_qt5OpenGL_install_prefix}/lib/libQt5OpenGLd.a" )
        _populate_OpenGL_target_properties(DEBUG "libQt5OpenGLd.a" "" )
    endif()
