...
set(Qt5Xml_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::Xml)
    ...
    foreach(_module_dep ${_Qt5Xml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5Xml_VERSION_STRING} ${_Qt5Xml_FIND_VERSION_EXACT}
    ...
    _populate_Xml_target_properties(RELEASE "libQt5Xml.a" "" )

    if (EXISTS "${_qt5Xml_install_prefix}/lib/libQt5Xmld.a" )
        _populate_Xml_target_properties(DEBUG "libQt5Xmld.a" "" )
    endif()
