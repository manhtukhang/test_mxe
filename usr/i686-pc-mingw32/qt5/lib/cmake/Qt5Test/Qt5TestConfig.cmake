...
set(Qt5Test_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::Test)
    ...
    foreach(_module_dep ${_Qt5Test_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5Test_VERSION_STRING} ${_Qt5Test_FIND_VERSION_EXACT}
    ...
    _populate_Test_target_properties(RELEASE "libQt5Test.a" "" )

    if (EXISTS "${_qt5Test_install_prefix}/lib/libQt5Testd.a" )
        _populate_Test_target_properties(DEBUG "libQt5Testd.a" "" )
    endif()
