...
set(Qt5Qml_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::Qml)
    ...
    foreach(_module_dep ${_Qt5Qml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5Qml_VERSION_STRING} ${_Qt5Qml_FIND_VERSION_EXACT}
    ...
    if (EXISTS "${_qt5Qml_install_prefix}/lib/libQt5Qmld.a" )
        _populate_Qml_target_properties(DEBUG "libQt5Qmld.a" "" )
    endif()
