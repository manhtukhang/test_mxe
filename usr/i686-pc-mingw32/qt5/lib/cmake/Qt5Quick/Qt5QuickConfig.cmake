...
set(Qt5Quick_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::Quick)
    ...
    foreach(_module_dep ${_Qt5Quick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5Quick_VERSION_STRING} ${_Qt5Quick_FIND_VERSION_EXACT}
    ...
    _populate_Quick_target_properties(RELEASE "libQt5Quick.a" "" )

    if (EXISTS "${_qt5Quick_install_prefix}/lib/libQt5Quickd.a" )
        _populate_Quick_target_properties(DEBUG "libQt5Quickd.a" "" )
    endif()
