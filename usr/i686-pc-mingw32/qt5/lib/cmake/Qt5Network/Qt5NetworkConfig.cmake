...
set(Qt5Network_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::Network)
    ...
    foreach(_module_dep ${_Qt5Network_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5Network_VERSION_STRING} ${_Qt5Network_FIND_VERSION_EXACT}
    ...
    _populate_Network_target_properties(RELEASE "libQt5Network.a" "" )

    if (EXISTS "${_qt5Network_install_prefix}/lib/libQt5Networkd.a" )
        _populate_Network_target_properties(DEBUG "libQt5Networkd.a" "" )
    endif()
