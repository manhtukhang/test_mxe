...
set(Qt5AxBase_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::AxBase)
    ...
    set(Qt5AxBase_PRIVATE_INCLUDE_DIRS
        "${_qt5AxBase_install_prefix}/include/ActiveQt/${Qt5AxBase_VERSION_STRING}"
        "${_qt5AxBase_install_prefix}/include/ActiveQt/${Qt5AxBase_VERSION_STRING}/ActiveQt"
    )

    foreach(_dir ${_Qt5AxBase_OWN_INCLUDE_DIRS}
                 ${Qt5AxBase_PRIVATE_INCLUDE_DIRS}
                 )
    ...
    set(_Qt5AxBase_MODULE_DEPENDENCIES "Gui;Core")
    ...
    foreach(_module_dep ${_Qt5AxBase_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5AxBase_VERSION_STRING} ${_Qt5AxBase_FIND_VERSION_EXACT}
    ...
    if (Qt5AxBase_EXECUTABLE_COMPILE_FLAGS)
        list(REMOVE_DUPLICATES Qt5AxBase_EXECUTABLE_COMPILE_FLAGS)
    endif()

    set(_Qt5AxBase_LIB_DEPENDENCIES "Qt5::Gui;Qt5::Core")
    ...
    if (EXISTS "${_qt5AxBase_install_prefix}/lib/libQt5AxBased.a" )
