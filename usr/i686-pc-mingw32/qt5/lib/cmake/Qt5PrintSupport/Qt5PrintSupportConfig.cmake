...
set(Qt5PrintSupport_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::PrintSupport)
    ...
    foreach(_module_dep ${_Qt5PrintSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5PrintSupport_VERSION_STRING} ${_Qt5PrintSupport_FIND_VERSION_EXACT}
    ...
    _populate_PrintSupport_target_properties(RELEASE "libQt5PrintSupport.a" "" )

    if (EXISTS "${_qt5PrintSupport_install_prefix}/lib/libQt5PrintSupportd.a" )
        _populate_PrintSupport_target_properties(DEBUG "libQt5PrintSupportd.a" "" )
    endif()
