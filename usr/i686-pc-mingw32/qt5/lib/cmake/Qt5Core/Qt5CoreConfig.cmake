...
set(Qt5Core_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::Core)
    ...
    foreach(_module_dep ${_Qt5Core_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5Core_VERSION_STRING} ${_Qt5Core_FIND_VERSION_EXACT}
    ...
    if (EXISTS "${_qt5Core_install_prefix}/lib/libQt5Cored.a" )
        _populate_Core_target_properties(DEBUG "libQt5Cored.a" "" )
    endif()
