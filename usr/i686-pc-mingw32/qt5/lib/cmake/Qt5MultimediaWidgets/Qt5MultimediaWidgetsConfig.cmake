...
set(Qt5MultimediaWidgets_VERSION_STRING 5.1.0)
...
if (NOT TARGET Qt5::MultimediaWidgets)
    ...
    foreach(_dir ${_Qt5MultimediaWidgets_OWN_INCLUDE_DIRS}
                 ${Qt5MultimediaWidgets_PRIVATE_INCLUDE_DIRS}
                 )
    ...
    foreach(_module_dep ${_Qt5MultimediaWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ${Qt5MultimediaWidgets_VERSION_STRING} ${_Qt5MultimediaWidgets_FIND_VERSION_EXACT}
    ...
    add_library(Qt5::MultimediaWidgets STATIC IMPORTED)
    set_property(TARGET Qt5::MultimediaWidgets PROPERTY IMPORTED_LINK_INTERFACE_LANGUAGES CXX)
    ...
    _populate_MultimediaWidgets_target_properties(RELEASE "libQt5MultimediaWidgets.a" "" )

    if (EXISTS "${_qt5MultimediaWidgets_install_prefix}/lib/libQt5MultimediaWidgetsd.a" )
        _populate_MultimediaWidgets_target_properties(DEBUG "libQt5MultimediaWidgetsd.a" "" )
    endif()
