...
#define MASK_LONG_DOUBLE_64 (1 << 14)
...
#define MASK_MS_BITFIELD_LAYOUT (1 << 15)
#define MASK_NO_PUSH_ARGS (1 << 16)
#define MASK_NO_RED_ZONE (1 << 17)
#define OPTION_MASK_ISA_SSE4_1 (HOST_WIDE_INT_1 << 23)
#define MASK_OMIT_LEAF_FRAME_POINTER (1 << 18)
#define OPTION_MASK_ISA_PCLMUL (HOST_WIDE_INT_1 << 24)
#define OPTION_MASK_ISA_POPCNT (HOST_WIDE_INT_1 << 25)
#define MASK_PREFER_AVX128 (1 << 19)
...
#define MASK_RECIP (1 << 20)
#define MASK_RTD (1 << 21)
...
enum opt_code
{
  ...
  OPT_Wpedantic_ms_format = 307,             /* -Wpedantic-ms-format */
  ...
  OPT_fcall_saved_ = 483,                    /* -fcall-saved- */
  OPT_fcall_used_ = 484,                     /* -fcall-used- */
  OPT_fcaller_saves = 485,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 486,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 487,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 488,                /* -fcheck-data-deps */
  OPT_fcheck_new = 489,                      /* -fcheck-new */
  OPT_fcheck_references = 490,               /* -fcheck-references */
  OPT_fcheck_ = 491,                         /* -fcheck= */
  OPT_fclasspath_ = 492,                     /* -fclasspath= */
  OPT_fcoarray_ = 493,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 494,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 495,                         /* -fcommon */
  OPT_fcompare_debug = 496,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 497,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 498,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 499,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 500,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 501,                  /* -fcond-mismatch */
  OPT_fconserve_space = 502,                 /* -fconserve-space */
  OPT_fconserve_stack = 503,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 504,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 505,               /* -fconstexpr-depth= */
  OPT_fconvert_big_endian = 506,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 507,          /* -fconvert=little-endian */
  OPT_fconvert_native = 508,                 /* -fconvert=native */
  OPT_fconvert_swap = 509,                   /* -fconvert=swap */
  OPT_fcprop_registers = 510,                /* -fcprop-registers */
  OPT_fcray_pointer = 511,                   /* -fcray-pointer */
  OPT_fcrossjumping = 512,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 513,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 514, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 515,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 516,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 517,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 518,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 519,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 520,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 521,                       /* -fdbg-cnt= */
  OPT_fdce = 522,                            /* -fdce */
  OPT_fdebug_cpp = 523,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 524,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 525,            /* -fdebug-types-section */
  OPT_fdeduce_init_list = 526,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 527,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 528, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 529,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 530,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 531,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 532,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 533,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 534,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 535,                   /* -fdevirtualize */
  OPT_fdiagnostics_show_caret = 536,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 537,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 538,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 539,                /* -fdirectives-only */
  OPT_fdisable_ = 540,                       /* -fdisable- */
  OPT_fdisable_assertions = 541,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 542,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 543,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 544,         /* -fdollars-in-identifiers */
  OPT_fdse = 545,                            /* -fdse */
  OPT_fdump_ = 546,                          /* -fdump- */
  OPT_fdump_ada_spec = 547,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 548,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 549, */                /* -fdump-core */
  OPT_fdump_final_insns = 550,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 551,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 552,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 553,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 554,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 555,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 556,                /* -fdump-parse-tree */
  OPT_fdump_passes = 557,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 558,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 559,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 560,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 561,                 /* -fearly-inlining */
  OPT_felide_constructors = 562,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 563,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 564, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 565,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 566,        /* -femit-class-debug-always */
  OPT_femit_class_file = 567,                /* -femit-class-file */
  OPT_femit_class_files = 568,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 569,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 570,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 571,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 572,                        /* -fenable- */
  OPT_fenable_assertions = 573,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 574,             /* -fenable-assertions= */
  OPT_fencoding_ = 575,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 576,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 577, */           /* -fenum-int-equiv */
  OPT_fexceptions = 578,                     /* -fexceptions */
  OPT_fexcess_precision_ = 579,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 580,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 581,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 582,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 583,                       /* -fextdirs= */
  OPT_fextended_identifiers = 584,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 585,                /* -fextern-tls-init */
  OPT_fexternal_blas = 586,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 587, */       /* -fexternal-templates */
  OPT_ff2c = 588,                            /* -ff2c */
  OPT_ffast_math = 589,                      /* -ffast-math */
  OPT_ffat_lto_objects = 590,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 591,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 592,               /* -ffinite-math-only */
  OPT_ffixed_ = 593,                         /* -ffixed- */
  OPT_ffixed_form = 594,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 595,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 596,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 597,                    /* -ffloat-store */
  OPT_ffor_scope = 598,                      /* -ffor-scope */
  /* OPT_fforce_addr = 599, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 600,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 601,              /* -fforward-propagate */
  OPT_ffp_contract_ = 602,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 603,                      /* -ffpe-trap= */
  OPT_ffree_form = 604,                      /* -ffree-form */
  OPT_ffree_line_length_ = 605,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 606,          /* -ffree-line-length-none */
  OPT_ffreestanding = 607,                   /* -ffreestanding */
  OPT_ffriend_injection = 608,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 609,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 610,                   /* -ffunction-cse */
  OPT_ffunction_sections = 611,              /* -ffunction-sections */
  OPT_fgcse = 612,                           /* -fgcse */
  OPT_fgcse_after_reload = 613,              /* -fgcse-after-reload */
  OPT_fgcse_las = 614,                       /* -fgcse-las */
  OPT_fgcse_lm = 615,                        /* -fgcse-lm */
  OPT_fgcse_sm = 616,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 617,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 618,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 619,                         /* -fgnu-tm */
  ...
  OPT_fset_stack_executable = 857,           /* -fset-stack-executable */
  ...
  OPT_fwritable_relocated_rdata = 997,       /* -fwritable-relocated-rdata */
  /* OPT_fxref = 998, */                     /* -fxref */
  /* OPT_fzee = 999, */                      /* -fzee */
  ...
  OPT_m128bit_long_double = 1040,            /* -m128bit-long-double */
  OPT_m32 = 1041,                            /* -m32 */
  OPT_m3dnow = 1042,                         /* -m3dnow */
  OPT_m3dnowa = 1043,                        /* -m3dnowa */
  OPT_m64 = 1044,                            /* -m64 */
  OPT_m80387 = 1045,                         /* -m80387 */
  OPT_m8bit_idiv = 1046,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1047,             /* -m96bit-long-double */
  OPT_mabi_ = 1048,                          /* -mabi= */
  OPT_mabm = 1049,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1050,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1051,                 /* -maddress-mode= */
  OPT_madx = 1052,                           /* -madx */
  OPT_maes = 1053,                           /* -maes */
  OPT_malign_double = 1054,                  /* -malign-double */
  OPT_malign_functions_ = 1055,              /* -malign-functions= */
  OPT_malign_jumps_ = 1056,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1057,                  /* -malign-loops= */
  OPT_malign_stringops = 1058,               /* -malign-stringops */
  OPT_march_ = 1059,                         /* -march= */
  OPT_masm_ = 1060,                          /* -masm= */
  OPT_mavx = 1061,                           /* -mavx */
  OPT_mavx2 = 1062,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1063,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1064,  /* -mavx256-split-unaligned-store */
  OPT_mbmi = 1065,                           /* -mbmi */
  OPT_mbmi2 = 1066,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1067,                  /* -mbranch-cost= */
  OPT_mcld = 1068,                           /* -mcld */
  OPT_mcmodel_ = 1069,                       /* -mcmodel= */
  OPT_mconsole = 1070,                       /* -mconsole */
  /* OPT_mcpu_ = 1071, */                    /* -mcpu= */
  OPT_mcrc32 = 1072,                         /* -mcrc32 */
  OPT_mcx16 = 1073,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1074,            /* -mdispatch-scheduler */
  OPT_mdll = 1075,                           /* -mdll */
  OPT_mf16c = 1076,                          /* -mf16c */
  OPT_mfancy_math_387 = 1077,                /* -mfancy-math-387 */
  OPT_mfentry = 1078,                        /* -mfentry */
  OPT_mfma = 1079,                           /* -mfma */
  OPT_mfma4 = 1080,                          /* -mfma4 */
  OPT_mforce_drap = 1081,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1082,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1083,                       /* -mfpmath= */
  OPT_mfsgsbase = 1084,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1085, */              /* -mfused-madd */
  OPT_mfxsr = 1086,                          /* -mfxsr */
  OPT_mhard_float = 1087,                    /* -mhard-float */
  OPT_mhle = 1088,                           /* -mhle */
  OPT_mieee_fp = 1089,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1090,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1091,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1092,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1093, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1094,         /* -mlarge-data-threshold= */
  OPT_mlong_double_64 = 1095,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1096,                /* -mlong-double-80 */
  OPT_mlwp = 1097,                           /* -mlwp */
  OPT_mlzcnt = 1098,                         /* -mlzcnt */
  OPT_mmmx = 1099,                           /* -mmmx */
  OPT_mmovbe = 1100,                         /* -mmovbe */
  OPT_mms_bitfields = 1101,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1102,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1103,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1104,                  /* -mno-push-args */
  OPT_mno_red_zone = 1105,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1106,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 1107,             /* -mnop-fun-dllimport */
  OPT_momit_leaf_frame_pointer = 1108,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1109,                          /* -mpc32 */
  OPT_mpc64 = 1110,                          /* -mpc64 */
  OPT_mpc80 = 1111,                          /* -mpc80 */
  OPT_mpclmul = 1112,                        /* -mpclmul */
  OPT_mpe_aligned_commons = 1113,            /* -mpe-aligned-commons */
  OPT_mpopcnt = 1114,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1115,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1116,     /* -mpreferred-stack-boundary= */
  OPT_mprfchw = 1117,                        /* -mprfchw */
  OPT_mpush_args = 1118,                     /* -mpush-args */
  OPT_mrdrnd = 1119,                         /* -mrdrnd */
  OPT_mrdseed = 1120,                        /* -mrdseed */
  OPT_mrecip = 1121,                         /* -mrecip */
  OPT_mrecip_ = 1122,                        /* -mrecip= */
  OPT_mred_zone = 1123,                      /* -mred-zone */
  OPT_mregparm_ = 1124,                      /* -mregparm= */
  OPT_mrtd = 1125,                           /* -mrtd */
  OPT_mrtm = 1126,                           /* -mrtm */
  OPT_msahf = 1127,                          /* -msahf */
  OPT_msoft_float = 1128,                    /* -msoft-float */
  OPT_msse = 1129,                           /* -msse */
  OPT_msse2 = 1130,                          /* -msse2 */
  OPT_msse2avx = 1131,                       /* -msse2avx */
  OPT_msse3 = 1132,                          /* -msse3 */
  OPT_msse4 = 1133,                          /* -msse4 */
  OPT_msse4_1 = 1134,                        /* -msse4.1 */
  OPT_msse4_2 = 1135,                        /* -msse4.2 */
  OPT_msse4a = 1136,                         /* -msse4a */
  /* OPT_msse5 = 1137, */                    /* -msse5 */
  OPT_msseregparm = 1138,                    /* -msseregparm */
  OPT_mssse3 = 1139,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1140,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1141,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1142,            /* -mstringop-strategy= */
  OPT_mtbm = 1143,                           /* -mtbm */
  OPT_mthreads = 1144,                       /* -mthreads */
  OPT_mtls_dialect_ = 1145,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1146,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1147,                         /* -mtune= */
  OPT_muse_libstdc_wrappers = 1148,          /* -muse-libstdc-wrappers */
  OPT_mveclibabi_ = 1149,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1150,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1151,                    /* -mvzeroupper */
  OPT_mwin32 = 1152,                         /* -mwin32 */
  OPT_mwindows = 1153,                       /* -mwindows */
  OPT_mx32 = 1154,                           /* -mx32 */
  OPT_mxop = 1155,                           /* -mxop */
  OPT_mxsave = 1156,                         /* -mxsave */
  OPT_mxsaveopt = 1157,                      /* -mxsaveopt */
  OPT_n = 1158,                              /* -n */
  OPT_no_canonical_prefixes = 1159,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1160,              /* -no-integrated-cpp */
  OPT_no_pthread = 1161,                     /* -no-pthread */
  OPT_nocpp = 1162,                          /* -nocpp */
  OPT_nodefaultlibs = 1163,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1164,                   /* -nostartfiles */
  OPT_nostdinc = 1165,                       /* -nostdinc */
  OPT_nostdinc__ = 1166,                     /* -nostdinc++ */
  OPT_nostdlib = 1167,                       /* -nostdlib */
  OPT_o = 1168,                              /* -o */
  OPT_p = 1169,                              /* -p */
  OPT_pass_exit_codes = 1170,                /* -pass-exit-codes */
  /* OPT_pedantic = 1171, */                 /* -pedantic */
  OPT_pedantic_errors = 1172,                /* -pedantic-errors */
  OPT_pg = 1173,                             /* -pg */
  OPT_pie = 1174,                            /* -pie */
  OPT_pipe = 1175,                           /* -pipe */
  OPT_posix = 1176,                          /* -posix */
  OPT_print_file_name_ = 1177,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1178,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1179,          /* -print-multi-directory */
  OPT_print_multi_lib = 1180,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1181,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1182,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1183,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1184,               /* -print-prog-name= */
  OPT_print_search_dirs = 1185,              /* -print-search-dirs */
  OPT_print_sysroot = 1186,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1187,   /* -print-sysroot-headers-suffix */
  OPT_pthread = 1188,                        /* -pthread */
  OPT_quiet = 1189,                          /* -quiet */
  OPT_r = 1190,                              /* -r */
  ...
  OPT_static_libstdc__ = 1206,               /* -static-libstdc++ */
  OPT_static_libtsan = 1207,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1208, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1209, */                /* -std=c++0x */
  OPT_std_c__11 = 1210,                      /* -std=c++11 */
  OPT_std_c__1y = 1211,                      /* -std=c++1y */
  OPT_std_c__98 = 1212,                      /* -std=c++98 */
  OPT_std_c11 = 1213,                        /* -std=c11 */
  /* OPT_std_c1x = 1214, */                  /* -std=c1x */
  /* OPT_std_c89 = 1215, */                  /* -std=c89 */
  OPT_std_c90 = 1216,                        /* -std=c90 */
  OPT_std_c99 = 1217,                        /* -std=c99 */
  /* OPT_std_c9x = 1218, */                  /* -std=c9x */
  OPT_std_f2003 = 1219,                      /* -std=f2003 */
  OPT_std_f2008 = 1220,                      /* -std=f2008 */
  OPT_std_f2008ts = 1221,                    /* -std=f2008ts */
  OPT_std_f95 = 1222,                        /* -std=f95 */
  OPT_std_gnu = 1223,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1224, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1225, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1226,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1227,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1228,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1229,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1230, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1231, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1232,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1233,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1234, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1235, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1236,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1237, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1238, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1239, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1240,                     /* -std=legacy */
  OPT_symbolic = 1241,                       /* -symbolic */
  OPT_t = 1242,                              /* -t */
  OPT_time = 1243,                           /* -time */
  OPT_time_ = 1244,                          /* -time= */
  OPT_traditional = 1245,                    /* -traditional */
  OPT_traditional_cpp = 1246,                /* -traditional-cpp */
  OPT_trigraphs = 1247,                      /* -trigraphs */
  OPT_u = 1248,                              /* -u */
  OPT_undef = 1249,                          /* -undef */
  OPT_v = 1250,                              /* -v */
  OPT_version = 1251,                        /* -version */
  OPT_w = 1252,                              /* -w */
  OPT_wrapper = 1253,                        /* -wrapper */
  OPT_x = 1254,                              /* -x */
  OPT_z = 1255,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
